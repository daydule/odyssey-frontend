...
export const AboutCardWithImageRight = (props: AboutCardWithImageProps) => {
  // TODO: テキストが長すぎる時に枠を大きくする（画像の表示も変にならないようにする）

  return (
    <div
      className='flex flex-col-reverse rounded-b-3xl border shadow-lg md:h-[384px] md:flex-row md:rounded-[50px] lg:h-[612px] lg:w-[1024px]'
    ...
    >
      <div className='p-4 text-center md:w-1/2 md:p-12' data-testid='AboutCardWithImage_TextArea'>
        ...
        <p className='mt-4 text-2xl md:mt-12'>{props.text}</p>
      </div>
